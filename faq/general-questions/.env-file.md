...
Your `.env` file contains sensitive data. <mark style="background-color:$danger;">**Never**</mark> <mark style="background-color:$danger;"></mark><mark style="background-color:$danger;">upload it to GitHub, GitLab, or any public repository.</mark> If you do, anyone with access to the repository can steal your credentials.
