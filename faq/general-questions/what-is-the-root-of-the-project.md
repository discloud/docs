...
| ----------------------------------------------- | ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| Compactar a pasta principal em vez da raiz real | Configuração / arquivo principal ausente  | Compacte diretamente a pasta que contém [`discloud.config`](https://github.com/discloud/docs/blob/portuguese/configurations/discloud.config) |
...
| Múltiplos arquivos de entrada ambíguos          | Falha na inicialização                    | Defina `MAIN` em [`discloud.config`](https://github.com/discloud/docs/blob/portuguese/configurations/discloud.config) explicitamente         |
