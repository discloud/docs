...
| Tokens hardcoded no código                      | Exposição de dados sensíveis              | Use [`.env`](arquivo-.env.md) e variáveis de ambiente                                              |
