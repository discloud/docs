...
Once you have identified your main file, you must specify it in your [**`discloud.config`**](../../configurations/discloud.config/README.md) file using the `MAIN` property.
